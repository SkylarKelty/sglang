# Adapted from
# https://huggingface.co/OpenMOSS-Team/MOSS-TTS-Realtime/blob/main/configuration_mossttsrealtime.py
...
class MossTTSRealtimeConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.local_config = _ensure_config(
            local_config, MossTTSRealtimeLocalTransformerConfig
        )
        # Propagate attention implementation to sub-configs
        attn_impl = getattr(self, "_attn_implementation", "eager")
